...
<!-- by this code session get all product that user chose -->
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    <td data-th="Product">
                        <div class="row">
                            <div class="col-sm-3 hidden-xs"><img src="{{ asset('image/products/'.$details['photo']) }}" width="100" height="100" class="img-responsive"/></div>
                            <div class="col-sm-9">
                    ...
                    <td class="actions" data-th="">
                       ...
                       <!-- this button is for update card -->
                        <button class="btn btn-danger btn-sm remove-from-cart delete" data-id="{{ $id }}"><i class="fa fa-trash-o"></i>Drop</button>
                    </td>
                </tr>
            @endforeach
        @endif
        ...
        <tr>
            ...
            <td class="hidden-xs text-center"><strong>Total P{{ $total }}</strong></td>
        </tr>
        </tfoot>
    </table>
